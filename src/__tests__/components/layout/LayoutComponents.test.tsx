...
describe('Layout Components', () => {
  describe('MainLayout', () => {
    ...
    it('should use layout hook for panel widths', () => {
      const mockUseLayout = require('@/store').useLayout
      render(<MainLayout />)
      
      expect(mockUseLayout).toHaveBeenCalled()
    })
  })
  ...
  describe('CanvasPanel', () => {
    ...
    it('should render custom children when provided', () => {
      const customContent = <div data-testid="custom-content">Custom Canvas Content</div>
  ...
  describe('PalettePanel', () => {
    ...
    it('should render custom children when provided', () => {
      const customContent = <div data-testid="palette-custom">Custom Palette Content</div>
  ...
  describe('PropertiesPanel', () => {
    ...
    it('should render custom children when provided', () => {
      const customContent = <div data-testid="properties-custom">Custom Properties Content</div>
      ...
      // Should not render placeholder when children are provided
      expect(screen.queryByText('Component properties will be here')).toBeFalsy()
    })
  ...
  describe('Panel Integration', () => {
    ...
    it('should handle empty className prop', () => {
      const { container: canvasContainer } = render(<CanvasPanel className="" />)
      const { container: paletteContainer } = render(<PalettePanel className="" />)
      const { container: propertiesContainer } = render(<PropertiesPanel className="" />)
